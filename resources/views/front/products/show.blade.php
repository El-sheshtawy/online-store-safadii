                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <h3 class="price">{{ Currency::formatAppCurrency( $product->compare_price) }}
                                    <span class="discount-price">
                                        {{ Currency::formatAppCurrency( $product->price) }}
                                    </span>
                                @else
                                    <h3 class="price">{{ Currency::formatAppCurrency( $product->price) }}
                                @endif
                            <p class="info-text">
                                {{ $product->description }}
                            </p>
