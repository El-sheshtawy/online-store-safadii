                            ...
                            <li>
                                <div class="select-position">
                                    ...
                                    <select name="currency_code" onchange="this.form.submit()">
                                        ...
                                        <option value="SAR" @selected('SAR' == session('currency_code')) >¥ CNY</option>
                                        <option value="QAR" @selected('QAR' == session('currency_code')) >৳ BDT</option>
                                    </select>
                                     </form>
                                </div>
                            </li>
                    ...
                    <div class="top-end">
                            ...
                            <ul class="user-login">
                                <li>
                                    ...
                                    <div class="user">
                                        <i class="lni lni-user"></i>
                                      @lang('app.Hello Guest')
                                    </div>
                                    <ul class="user-login">
                                    <li>
                                        <a href="/login">{{ Lang::get('app.Login') }}</a>
                                    </li>
                                    <li>
                                        <a href="/register">{{ __('app.Register') }}</a>
                                    </li>
                                    </ul>
                                    @endauth
                    </div>
