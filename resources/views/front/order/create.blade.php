                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <ul class="breadcrumb-nav">
                            ...
                            <li><a href="{{ route('stripe.show') }}">checkout</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="form-input form">
                                                    <x-form.input name="address[billing][email]" placeholder="Email"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="form-input form">
                                                    <x-form.input name="address[billing][street_addr]" placeholder="Street address"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="form-input form">
                                                    <x-form.input name="address[billing][postal_code]" placeholder="Postal Code"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-checkbox checkbox-style-3">
                                                ...
                                                <p>My delivery and mailing addres are the same.</p>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Email address</label>
                                                <div class="form-input form">
                                                    <x-form.input name="address[shipping][email]" placeholder="Email"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                <label>Mailing address</label>
                                                <div class="form-input form">
                                                    <x-form.input name="address[shipping][street_addr]" placeholder="Street address"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Post Code</label>
                                                <div class="form-input form">
                                                    <x-form.input name="address[shipping][postal_code]" placeholder="Postal Code"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                        ...
                        <div class="checkout-sidebar-price-table mt-30">
                            ...
                            <div class="sub-total-price">
                                <div class="total-price">
                                    ...
                                    <p class="price">{{ Currency::formatAppCurrency(\App\Http\Facades\Cart::total()) }}</p>
                                </div>
